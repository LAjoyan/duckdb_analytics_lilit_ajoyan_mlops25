INSERT INTO
    database_shema.sql (word, description)
VALUES
    (
        'query',
...
VALUES
    (
        'CRUD',
        'create, read, update, delete - basic actions to be performed on data'
    ),
    (
        'range condition',
        'filter data within a specific range of values'
    );
...
INSERT INTO
    programming_schema.python (word, description)
VALUES
    ('class', 'code template for creating objects');

INSERT INTO
    database_shema.duckdb (word, description)
VALUES
    (
        'DuckDB',
